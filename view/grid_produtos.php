<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
 <link href="model/css/card-list.css" rel="stylesheet">
 <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Grid de Produtos</h1>
...
<div class="container my-4 ">
  <div id="mylist" class="card p-3">
    <div class="row">
      <div class="col-6">
        <input type="search" class="search form-control" placeholder="Pesquisar">
      </div>
      <div class="col-2">
  ...
  <div style="display:none;">
    ...
    <div id="myitem" class="col-md-3">
      <div class="card mt-3">
        <div class="img"></div>
        <div class="card-body">
          <h5 class="descprod"></h5>
          <small class="caracteristicas text-muted"></small>
        </div>
        <div class="card-footer d-flex justify-content-between">
          <div class="vlrunitario"></div>
          <div class="botao"></div>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="addItemModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
